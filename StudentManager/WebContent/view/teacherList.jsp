	...
	$(function() {	
	    ...
	    $("#edit").click(function(){
        	...
        	if(selectRows.length != 1){
            	$.messager.alert("Notification", "Please select  data to operate!", "warning");
            } else{
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("Notification", "All data related to the teacher will be deleted, confirm to continue?", function(r){
            		if(r){
            			$.ajax({
							type: "post",
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										$.messager.alert("Notification","Successfully edited!","info");
										//close
