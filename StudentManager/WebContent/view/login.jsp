		...
		$("#submitBtn").click(function(){
			...
			$.ajax({
				...
				success: function(msg){
					 if("loginError" == msg){
						$.messager.alert("Notification", "Wrong user name or password!", "warning");
...
<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 800px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">Student Management System</h2>
</div>
